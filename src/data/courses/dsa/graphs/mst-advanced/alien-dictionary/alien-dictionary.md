...
> Use Build Graph from Adjacent Words + Topo Sort (Optimal) for O(C) where C = total characters across all words time.

<br>

---

## Solution 2: Build Graph from Adjacent Words + Topo Sort (Optimal)
